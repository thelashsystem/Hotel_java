...
<c:set var="getAllServiceUrl" value="${pageContext.request.contextPath }/management/service/getAllService" />
			...
			<section class='col-md-12 mt20' id='main_content'>
				<div class='box box-solid box-primary'>
					<div class='box-header'>
						<h3 class='box-title'>
							<a
								href='${pageContext.request.contextPath }/management/apartment/manageApartment.html'>Service
								List</a>
						</h3>
										...
										<div
											...
											<div class='modal-header'>
												<h5 class='modal-title' id="myModalLabel1">
													<i class="fa fa-building"></i> &nbsp;Add New Service
											...
											<form action='${addApartmentUrl }' method='post'
												...
												<div class='modal-body'>
													<div class='row'>
														<label class='col-md-3 col-xs-3 col-sm-3' for="name">Room Type
															Name: </label> <span class='col-md-3 col-xs-3 col-sm-3'><input
															class='form-control' type='text' name='name'
															placeholder='Room Name' id='name' /> </span> <label
															class='col-md-3'>Room Code: </label> <span
															class='col-md-3'> <input type="text" /> </span>
													</div>
													<div class='row'>
														<label class='col-md-3 col-xs-3 col-sm-3'
															for='address.addressName'>Is Hot? : </label> <span
															class='col-md-4 col-xs-4 col-sm-4'> <input type="checkbox" />
														</span> <label class='col-md-2 col-xs-2 col-sm-2'>Is New? :
														</label> <span class='col-md-3 col-xs-3 col-sm-3'> <input type="checkbox" />
														</span>
													</div>
													<div class='row'>
														<label class='col-md-3 col-xs-3 col-sm-3'
															for='address.addressName'>Priority Order: </label> <span
															class='col-md-2 col-xs-2 col-sm-2'> <input type='text' class='form-control' />
														</span> 
													</div>
													<div class='row'>
														<label class='col-md-4 col-xs-4 col-sm-4'>Current price: 
														</label> <span class='col-md-2 col-xs-2 col-sm-2'> <input type='text' class='form-control' />
														</span>
													</div>
													<div class='row'>
