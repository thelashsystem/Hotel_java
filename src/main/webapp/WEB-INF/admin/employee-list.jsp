...
<c:set var="getAllEmployeeUrl"
	value="${pageContext.request.contextPath }/management/employee/getAllEmployee.html" />
<c:set var="getEmployeeByIdUrl"
	value="${pageContext.request.contextPath }/management/employee/getEmployeeById" />
<c:set var="addEmployeeUrl"
	value="${pageContext.request.contextPath }/management/employee/addEmployee" />
<c:set var="updateEmployeeUrl"
	value="${pageContext.request.contextPath }/management/employee/updateEmployee" />
<c:set var="deleteEmployeeUrl"
	value="${pageContext.request.contextPath }/management/employee/deleteEmployee" />
			...
			<section class='col-md-12 mt20' id='main_content'>
				<div class='box box-solid box-primary'>
					<div class='box-header'>
						<h3 class='box-title'>
							<a
								href='${pageContext.request.contextPath }/management/employee/manageEmployee.html'>Employee
								List</a>
						</h3>
						<div class='box-tools pull-right'>
							<a href='#add_employee' data-toggle='modal'>
										...
										<div
											...
											<div class='modal-header'>
												<h5 class='modal-title' id="myModalLabel1">
													<i class="fa fa-building"></i> &nbsp;Add New Employee
												...
												<div class='modal-body'>
													<div class='row'>
														<label class='col-md-3 col-xs-3 col-sm-3'>
															Employee Code: </label> <span class='col-md-3 col-xs-3 col-sm-3'><input
															class='form-control' type="text" name="employeeCode"
															placeholder="Employee Code" /> </span> <label
															class='col-md-2 col-xs-2 col-sm-2'>Position:</label> <select
															class='col-md-4 col-xs-4 col-sm-4 chosen-select25'
															name='position' style="width: 33.3333%">
															<option value="0" disabled="disabled" selected="selected">Select
																position</option>
															<option value="1">Guard</option>
															<option value="2">Cleaning Person</option>
										...
										<div
											...
											<div class='modal-header'>
												<h5 class='modal-title' id="myModalLabel2">
													<i class="fa fa-building"></i> &nbsp;Update Employee
													<button type="button" class="close" data-dismiss="modal"
														aria-label="Close">
														<span aria-hidden="true">&times;</span>
													</button>
						...
						<table id="table" class="display" width="100%">
							<thead>
								<tr>
									...
									<th class='col-md-2'>Employee Code</th>
												...
												"columns" : [
														{
															...
															"mRender" : function(
																	data, type,
																	full) {
																return "<a href='#update_employee' class='mr10 alert_update' data-toggle='modal' data-target='#modalUpdate'>"
																		...
																		+ "<a href='#delete_employee' class='alert_delete' ><span class='fa-1x2 fa fa-trash-o'></span></a>";
															}
														},
														{
															"data" : "fullName"
									...
									.on(
											...
											function() {
												var id = table.row(
														$(this).parents('tr'))
														.data().id;
												location.href = 'employee-detail.html?id='
														+ id;
											});
