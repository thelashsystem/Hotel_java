...
<c:set var="getAllBookingUrl" value="${pageContext.request.contextPath }/management/booking/getAllBooking" />
			...
			<section class='col-md-12 mt20' id='main_content'>
				<div class='box box-solid box-primary'>
					<div class='box-header'>
						<h3 class='box-title'>
							<a
								href='${pageContext.request.contextPath }/management/apartment/manageApartment.html'>Booking Apartment
								List</a>
						</h3>
												...
												<div class='modal-body'>
													<div class='row'>
														<label class='col-md-3 col-xs-4 col-sm-3' for="name">Apartment
															Name: </label> 
															<span class='col-md-9 col-xs-8 col-sm-9'><input class='form-control'
															type='text' name='name' placeholder='Apartment Name'
															id='name' /> </span>
													</div>
													<div class='row'>
														<label class='col-md-3 col-xs-3 col-sm-3'
															for='address.addressName'>Address: </label> <span class='col-md-9 col-xs-9 col-sm-9'><input
													...
													<div class='row'>
														<label class='col-md-3 col-xs-3' for='phone'>Phone
															Number: </label> 
															<span class='col-md-9 col-xs-9'><input class='form-control' type='text'
															name='phone' id='phone' placeholder='Phone Number' /> 
															</span>
													</div>
													<div class='row'>
														<label
															class='col-md-3 col-xs-3' for='wardName'>Ward: </label> <span class='col-md-9 col-xs-9 '> <input
															class='form-control' type='text'
															name='address.wardName' id='wardName' placeholder='Ward' /> </span>
													</div>
													<div class='row'>
					...
					<thead>
						<tr>
							...
							<th class='col-md-3'>Apartment</th>
