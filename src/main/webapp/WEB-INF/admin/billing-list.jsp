...
<c:set value="${pageContext.request.contextPath }/management/billing/getAllBilling" var="getAllBillingUrl" />
			...
			<section class='col-md-12 mt20' id='main_content'>
				<div class='box box-solid box-primary'>
					<div class='box-header'>
						<h3 class='box-title'>
							<a
								href='${pageContext.request.contextPath }/management/apartment/manageApartment.html'>Billing
								List</a>
						</h3>
				...
				.ready(
						function() {
							...
							$(document).on('click', '.view_detail', function() {
								...
								location.href = 'detail-apartment?id=' + id;
							});
